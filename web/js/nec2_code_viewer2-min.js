...
return t=t[C](/(,-)0[.]/g,"$1.")[_](/,(?=[a-z][a-z],|[a-z][a-z]$)/gi),t.forEach(function(t){t=t[b](),t&&(t=t[_](","),t=t[0]in r?r[t[0]](t):r.general(t),t[v]&&(n+=t.join(",")+","))}),n},t[L]=t[L]||function(t){return t[r].match(/^[\s\r\n]*(CM|CE|GW|SY)\s[\s\S]*\n(GE)/i)},t[E]=t[E]||function(t,e){var r,n,i,o,s=function(t){return t*w.PI/180},a=function(t){return 180*t/w.PI},l="http://mladenov.ca/~nickm/viewer/_g2.html#",h="",c=l+"message=",u=c+"failed_to_",f=w.round,d=T,p=function(t){return f(t*d)/d},x=function(t){var e=T*t
